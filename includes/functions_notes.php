...
global $oauth2;
    ...
    $nomin=json_decode(file_get_contents("https://nominatim.openstreetmap.org/reverse?lat=".$result['geometry']['coordinates'][1]."&lon=".$result['geometry']['coordinates'][0]."&format=json"),true);
